...
**0.2.5 - the current release.** The planner, sets and set inheritance, the window with per-row
...
that the addon runs there. If you installed 0.1.0 on Mists Classic, 0.2.5 will not load for you -
